...
namespace wsmcbl.front.Accounting.TariffCollection.TariffCollectionBase
{
    public class TariffCollectionBase : ComponentBase
    {
        ...
        public TariffCollectionBase(TariffCollectionController controller, SweetAlertService Swal, NavigationManager navigationManager, IJSRuntime JSRuntime)
        {
